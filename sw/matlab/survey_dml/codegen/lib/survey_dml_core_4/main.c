...
#include "survey_dml_core_4_emxAPI.h"
#include "survey_dml_core_4_terminate.h"

/* Function Declarations */
static void argInit_1x2_real_T(double result[2]);
static emxArray_real_T *argInit_Unboundedx1_real_T(void);
static double argInit_real_T(void);
static void main_survey_dml_core_4(void);
...
static void main_survey_dml_core_4(void)
{
  ...
  // core
  survey_dml_core_4(NUMB_RND, NUMB_SMP, INDX_FIG, 
...
int main(int argc, const char * const argv[])
{
  ...
  main_survey_dml_core_4();

  /* Terminate the application.
     You do not need to do this more than one time. */
  survey_dml_core_4_terminate();
  return 0;
}
